...
# Utility to load CSV summaries with file existence check
...
# Utility to display plots with file existence check
...
# User Activity Distribution
    ...
    activity_summary = load_summary("visitor_event_counts.csv")
    if not activity_summary.empty:
        st.subheader("Visitor Event Counts Summary")
...
# Session Analysis
    ...
    if not session_length_summary.empty:
